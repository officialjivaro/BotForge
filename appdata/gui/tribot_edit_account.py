# \appdata\gui\tribot_edit_account.py
...
from appdata.logic.tribot_edit_account import TRiBotEditAccountLogic

class TribotEditAccountWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("TRiBot Edit Account")
        ...
        # notes_edit is now a normal QLineEdit for single-line text
        ...
        self.logic = TRiBotEditAccountLogic(self)
