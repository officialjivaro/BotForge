...
from appdata.logic.osbot_tasks import OsbotTasksLogic

class OsbotTasksWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("OSBot Task Manager")
        ...
        form_layout.addRow("Script Id (Name for Local Scripts):", self.script_id_input)
        ...
        # Instantiate the logic class, passing in self so it can hook button signals
        self.logic = OsbotTasksLogic(self)
